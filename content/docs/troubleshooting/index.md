...
Большая часть описанных выше шагов автоматизирована в инструменте `Получить глобальную проверку` | `Get Global check`, который находится во вкладке `Диагностика` | `Diagnostics`. Он покажет вам все ключевые настройки и статусы системы.

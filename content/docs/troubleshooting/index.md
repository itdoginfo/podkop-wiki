...
> *   Не открываются заблокированные сайты на одном из устройств, хотя на других всё работает? Проверьте **[настройки DNS на этом устройстве](#diagnostika-na-klientskom-ustroistve-pk-smartfon)**.
> *   В диагностике ошибка `FakeIP Status: ! does not work in browser`? Скорее всего, дело в **[DNS на устройстве](#diagnostika-na-klientskom-ustroistve-pk-smartfon)** или **[«Безопасном DNS» в браузере](/docs/client-dns/)**.

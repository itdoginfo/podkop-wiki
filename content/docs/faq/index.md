...
При использовании **Wg | Awg** подключения с WARP и пользовательского списка подсетей **Cloudflare** в другом туннеле, происходит зацикливание. Чтобы избежать этого укажите в дополнительных настройках **WG | Awg** интерфейса с WARP в поле **Firewall Mark** значение 0x90000. 

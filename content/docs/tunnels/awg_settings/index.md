...
Если вы не являетесь владельцем сервера, то у авторов AmneziaVPN есть свой [декодер](https://github.com/amnezia-vpn/config-decoder) под Windows. Вы можете им воспользоваться, но вывод, получаемый после декодирования, тяжело читать. Вам придется сопоставить полученные результаты и пример конфига и найти необходимые параметры самостоятельно.

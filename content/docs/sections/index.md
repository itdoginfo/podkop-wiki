...
В этом режиме сейчас поддерживаются следующие протоколы: `VLESS`, `Shadowsocks`, `Trojan` и `Socks` 4 и 5 версии.

Доступно три варианта настройки:

- **URL подключения | Connection URL**

Используется для ссылки вида **vless://** **ss://** **trojan://** **socks(4|5)://**. Просто вставьте свою ссылку.

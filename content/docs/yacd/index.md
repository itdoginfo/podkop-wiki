...
Поле **Secret** можно оставить пустым, если вы не активировали настройку **Enable YACD WAN Access**. В случае если настройка была активирована вам необходимо указать ключ, указанный в опции [**YACD Secret Key**](/docs/settings/#sekretnyj-klyuch-yacd--yacd-secret-key)
